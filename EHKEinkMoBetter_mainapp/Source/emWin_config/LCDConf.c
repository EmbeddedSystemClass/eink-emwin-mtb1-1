...
/*******************************************************************************
* Function Name: void LCD_CopyDisplayBuffer(uint8* destination, int count)
********************************************************************************
*
* Summary: This function copies the EmWin display buffer to an external buffer
*
* Parameters:
*  uint8* destination - pointer to the destination buffer
*  int count - number of bytes to be copied
*
* Return:
*  None
*
